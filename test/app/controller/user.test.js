...
describe('test/app/controller/user.test.js', () => {
  ...
  describe('- Admin', () => {
    ...
    it('should POST /user/:name/block set block ok', async () => {
      const result = await handleAdminPost(`/user/${user.loginname}/block`, { action: 'set_block' });
    ...
    it('should POST /user/:name/block cancel block ok', async () => {
      const result = await handleAdminPost(`/user/${user.loginname}/block`, { action: 'cancel_block' });
